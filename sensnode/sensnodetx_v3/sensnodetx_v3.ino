...
static byte NODEID = 5;       // ID this node
...
// Settings
#define MEASURE_PERIOD    500 // how often to measure, in tenths of seconds
...
#define LM35              0 // use analog temperature sensor LM35
...
#if LM35
  int reading;
  reading = analogRead(CustomA3);
  measure.temp = reading / 9.31;
#endif
